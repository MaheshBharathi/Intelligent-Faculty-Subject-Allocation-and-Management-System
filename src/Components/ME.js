...
//         axios.post('http://localhost:3000/users',course)
//     }
//     return (
//         <div>
...
//             <input type='checkbox' value='web'/><br></br>
//             <label>python</label>
//             <input type='checkbox' value='py'/><br></br>
//             <label> DBMS</label>
//             <input type='checkbox' value='dbms'/><br></br>
//             <label>Java</label>
//             <input type='checkbox' value='java'/><br></br>
//             <label>COA</label>
//             <input type='checkbox' value='coa'/><br></br>
...
//         if(type=='checkbox'){
//             setFormData(prev=>({...prev,courses:checked?[...prev.courses,value]:prev.courses.filter(x=>x!==value)}))
//         }
//         else{
...
//             </table>
//             <b><h1 className='mte4'><label htmlFor='sel'>Choose Your Courses:</label></h1></b><br></br>
//             <label htmlFor='wb'>Web Technology</label>
//             <input type='checkbox' value='web' name='courses' id='wb'onChange={handleChange} checked={formData.courses.includes('web')}/><br></br>
//             <label htmlFor='pyt'>python</label>
//             <input type='checkbox' value='py'name='courses' id='pyt' onChange={handleChange} checked={formData.courses.includes('py')}/><br></br>
//             <label htmlFor='db'> DBMS</label>
//             <input type='checkbox' value='dbms'name='courses'id='db'onChange={handleChange} checked={formData.courses.includes('dbms')}/><br></br>
//             <label htmlFor='jv'>Java</label>
//             <input type='checkbox' value='java'name='courses'id='jv'onChange={handleChange} checked={formData.courses.includes('java')}/><br></br>
//             <label htmlFor='ca'>COA</label>
//             <input type='checkbox' value='coa'name='courses'id='ca'onChange={handleChange} checked={formData.courses.includes('coa')}/><br></br>
//             <button className='mte2'type='submit'>Submit</button>
//             </center>
//             </form>
