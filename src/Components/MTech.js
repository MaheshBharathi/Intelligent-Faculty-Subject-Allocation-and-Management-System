...
//     const handleSubmit = (e) => {
//       e.preventDefault();
//       console.log('Selected Courses:', formData.courses);
//     };
//     return (
//       <form onSubmit={handleSubmit}>
//         <h1 className='mt4'>
//           <label htmlFor='sel'>Choose Your Courses:</label>
//         </h1>
//         <br />
//         <label htmlFor='cn'>Cryptography and Network Security</label>
//         <input
...
//           checked={formData.courses.includes('Cryptography')}
//         />
//         <br />
//         <label htmlFor='qc'>Quantum Computing</label>
//         <input
...
//           name='courses'
//           onChange={handleChange}
//           checked={formData.courses.includes('Quantum')}
//         />
//         <br />
//         <label htmlFor='ct'>Computational Theory</label>
//         <input
...
//           name='courses'
//           onChange={handleChange}
//           checked={formData.courses.includes('Computational')}
//         />
//         <br />
//         <label htmlFor='cv'>Computer Vision</label>
//         <input
...
//           name='courses'
//           onChange={handleChange}
//           checked={formData.courses.includes('Computer')}
//         />
//         <br />
//         <label htmlFor='ar'>Augmented Reality (AR)</label>
//         <input
...
//           name='courses'
//           onChange={handleChange}
//           checked={formData.courses.includes('Augmented')}
//         />
//         <br />
//         <label htmlFor='ads'>Advanced Database Systems</label>
//         <input
...
//           name='courses'
//           onChange={handleChange}
//           checked={formData.courses.includes('Database')}
//         />
//         <br />
//         <label htmlFor='bt'>Blockchain Technology</label>
//         <input
...
//           name='courses'
//           onChange={handleChange}
//           checked={formData.courses.includes('Blockchain')}
//         />
//         <br />
//         <br />
//         <button className='mt2' type='submit'>
//           Submit
//         </button>
//       </form>
//     );
